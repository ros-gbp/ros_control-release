## ros_control (noetic) - 0.20.0-1

The packages in the `ros_control` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic ros_control` on `Fri, 27 Oct 2023 11:42:15 -0000`
...
## ros_control (noetic) - 0.19.6-1

The packages in the `ros_control` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release --track noetic --rosdistro noetic ros_control` on `Fri, 21 Oct 2022 04:57:34 -0000`
...
## ros_control (noetic) - 0.19.5-1

The packages in the `ros_control` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release --track noetic --rosdistro noetic ros_control` on `Wed, 16 Jun 2021 13:25:15 -0000`
...
## ros_control (melodic) - 0.18.4-1

The packages in the `ros_control` repository were released into the `melodic` distro by running `/usr/local/bin/bloom-release --track melodic --rosdistro melodic ros_control` on `Wed, 16 Jun 2021 09:20:28 -0000`
...
## ros_control (noetic) - 0.19.4-1

The packages in the `ros_control` repository were released into the `noetic` distro by running `/home/bence/.local/bin/bloom-release --track noetic --rosdistro noetic ros_control` on `Sat, 05 Dec 2020 11:11:40 -0000`
...
## ros_control (melodic) - 0.18.3-1

The packages in the `ros_control` repository were released into the `melodic` distro by running `/home/bence/.local/bin/bloom-release --track melodic --rosdistro melodic ros_control` on `Sat, 05 Dec 2020 09:25:56 -0000`
...
## ros_control (noetic) - 0.19.2-1

The packages in the `ros_control` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --track noetic --rosdistro noetic ros_control` on `Mon, 17 Aug 2020 07:48:09 -0000`
...
## ros_control (melodic) - 0.18.2-1

The packages in the `ros_control` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --track melodic --rosdistro melodic ros_control` on `Mon, 17 Aug 2020 07:41:51 -0000`
...
## ros_control (noetic) - 0.19.1-1

The packages in the `ros_control` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --track noetic --rosdistro noetic ros_control` on `Sun, 10 May 2020 08:29:27 -0000`
...
## ros_control (melodic) - 0.18.1-1

The packages in the `ros_control` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --track melodic --rosdistro melodic ros_control` on `Sat, 09 May 2020 16:31:17 -0000`
...
The packages in the `ros_control` repository were released into the `indigo` distro by running `/usr/local/bin/bloom-release --track indigo --ros-distro indigo ros_control` on `Mon, 16 Apr 2018 19:16:06 -0000`
